...
var IndecisionApp = function (_React$Component) {
    ...
    _createClass(IndecisionApp, [{
        ...
        value: function componentDidMount() {
            try {
                if (localStorage.getItem('options') && JSON.parse(localStorage.getItem('options')).length > 0) {
        ...
        value: function removeSingleOption(opt) {
...
var Options = function Options(props) {
    return React.createElement(
        ...
        !props.options.length > 0 && React.createElement(
            'p',
            null,
            'No options found, please add an option to get started'
        ),
...
ReactDOM.render(React.createElement(IndecisionApp, { options: ['Shout', 'Run', 'Code', 'Play'] }), document.getElementById('app'));
