...
// this is the base component for exercise setup, from here we show the list of exercises and the add/edit exercise comp
export default class ExerciseSetup extends React.Component {

    state = {
            // used for local storage holds all the users exercises
            exercises: [],
            // Modal Values
            ...
            useWeight:true,
            useSet:true,
            // this array is used to influence the overall progress and changes the body display
            muscleGroups:[],
        ...
        handleEditAddClose=()=>{this.setState({display:'list'})}
        ...
        handleAddEditExercise = () => {
            ...
            if (!this.state.isExerciseEdit) {
                ...
                this.setState((prevState)=>({
                    ...
                    flashMessage:'Saved Data Locally'
        ...
        handleImg = (img) => {
            ...
            newImgEvent.on('imgready', function (newimg) {
                thisScope.setState((prevState) => ({
                    selectedFile: newimg,
                    flashMessage:'Resized Image and Saved Locally'
                }));
            });
    ...
    render(){
        ...
        return(
            ...
            {this.state.display==='addedit' &&  
                        ...
                        muscleGroups={this.state.muscleGroups}
                        handleClose={this.handleEditAddClose}
                        />
...
ExerciseSetup.defaultProps={
    exercises:[// image, exercise , can use weight, can use set,description, muscle groups inner array
        ['./img/benchpress.jpg','Bench press',true,true,'',[]],
        ['./img/squat.jpg','Squat',true,true,'',[]],
        ['./img/milpress.jpg','Shoulder press',true,true,'',[]],
